const warningMessages = {
    precisionSimulation: {
        default: {
            ...
            text: "Les montants de votre simulation sont susceptibles de varier à la hausse ou à la baisse en fonction des évolutions des autres collectivités de la Métropole qui partagent la même enveloppe budgétaire.",
        },
        alert: {
