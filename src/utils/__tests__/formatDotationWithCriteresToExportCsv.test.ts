...
describe("formatDotationWithCriteresToExportCsv(dotation: Dotation, titleTotal: string)", () => {
    ...
    it("should return an array formatted from dotation with one of the annee valeur is null to export CSV", () => {
        expect(
            formatDotationWithCriteresToExportCsv(
                {
                    ...dotationMocked,
            ...
            { "2021": "111261", "2022": "112712", title: undefined },
            {
                "2021": "86048",
                "2022": "90671",
                title: "Montant total de la Dotation Solidarité Rurale (DSR)",
