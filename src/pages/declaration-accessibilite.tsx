export default function DeclarationAccessibilite() {
    return (
        <div className="pt-3 pb-14 px-4 md:w-8/12 mx-auto flex flex-col">
            <h1>Déclaration d&apos;accessibilité</h1>
            <p>
                Établie le <span>10 mai 2023</span>.
            </p>
            <p>
                <span>Incubateur des Territoires</span> s&apos;engage à rendre
                son service accessible, conformément à l&apos;article 47 de la
            ...
            <ul className="flex flex-col">
                ...
                <li>
                    Adresse&nbsp;:{" "}
                    <span>
                        Mission incubateur de services numériques, 20, avenue de
                        Ségur, TSA 10717, 75 334 Paris Cedex 07
                    </span>
                </li>
            </ul>
            <p>
